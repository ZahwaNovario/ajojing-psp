...
class SecureHeaders
{
    ...
    private function setStrictCsp(Response $response): void
    {
        ...
        $policy .= " script-src 'self' 'unsafe-inline' $viteUrl https://cdn.jsdelivr.net;";
        $policy .= " style-src 'self' 'unsafe-inline' $viteUrl https://fonts.googleapis.com https://fonts.bunny.net https://cdn.jsdelivr.net;";
