...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\Git repo\\psp\\ajojing-psp\\public\\storage','logging.default','logging.deprecations.channel',
...
'dashboard','barang.index','barang.store','barang.update','barang.destroy',
'barang.image.delete','home','profile.edit','profile.update',
...
'admin.barang.create_barang','admin.barang.index','admin.components.navbar','admin.components.topbar','admin.dashboard',
'admin.layouts.app','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
...
'customer.home','layouts.app','layouts.customer','layouts.guest','layouts.navigation',
'layouts.partials.customer-footer','layouts.partials.customer-navbar','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
