...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\Git repo\psp\ajojing-psp\public\storage' => 'string',
...
'filesystems.links.D:\\Git repo\\psp\\ajojing-psp\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'cart.destroy_on_logout','cart.format.decimals','cart.format.decimal_point','cart.format.thousand_seperator','ide-helper.filename',
...
'produk.show','produk.index','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','dashboard','admin.barang.index','admin.barang.store',
'admin.barang.update','admin.barang.destroy','admin.barang.image.delete','admin.order.index','admin.users.index',
'admin.activity-log.login-log.index','pegawai.barang.index','pegawai.order.index','pegawai.order.konfirmasi','pegawai.order.tolak',
'cart.index','cart.add','cart.update','cart.remove','checkout.index',
'checkout.process','checkout.success','account.orders.index','account.orders.show','account.orders.confirm-payment',
'storage.local',);
        registerArgumentsSet('views', 
'admin.Order.index','admin.Order.pegawai','admin.activity-log.login-log.index','admin.barang.create_barang','admin.barang.index',
'admin.components.navbar','admin.components.topbar','admin.dashboard','admin.layouts.app','admin.users.index',
...
'components.primary-button','components.responsive-nav-link','components.secondary-button','components.text-input','customer.account.order-show',
'customer.account.orders','customer.cart.index','customer.checkout.index','customer.checkout.success','customer.home',
'customer.produk.index','customer.produk.show','layouts.app','layouts.customer','layouts.guest',
'layouts.navigation','layouts.partials.customer-footer','layouts.partials.customer-navbar','profile.edit','profile.partials.delete-user-form',
